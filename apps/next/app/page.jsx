  ...
  return (
    <main className="demo">
      ...
      <div className="section">
        <span className="pill">Next.js • React framework</span>
        <h1>Same shop. Different code.</h1>
        <p>
          Adds routing and rendering tools around React. This example generates
          HTML at build time.
        </p>
      </div>
      <div className="demo-grid">
        ...
        <aside className="lesson">
          ...
          <pre>
            <code>
              &#x27;use client&#x27;; const [quantity, setQuantity] =
              useState(1); // next.config.mjs: // output: &#x27;export&#x27;
            </code>
          </pre>
          <ol>
          ...
          <p>
            <strong>State model:</strong> useState + static export
          </p>
          <p className="small">
            Source: <code>apps/next/app/page.jsx</code>
          </p>
          <a href="../source/next.txt">Read this component</a> ·{" "}
